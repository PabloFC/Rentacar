...
<body>
    <main>
        ...
        if (isset($_SESSION["admin"])) {
            ...
            echo "<h1>Buscar noticias</h1>";
        ?>
            <section class="buscar_noticias">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-sm-6 caja_formu">
                            <div class="formu_contacta">
                                <h5 class="color_blanco">Introduce el titulo o subtitulo de la noticia</h5>
                                <br>
        ...
        <?php
            if (isset($_POST["enviar"])) {
                if (!$_POST["buscar"]) {
                    echo '<script>alert("Introduce el titulo o subtitulo de la noticia")</script>';
                } else {

                    $buscar = "%" . $_POST["buscar"] . "%";
                    $sentencia = "select * from noticia where titulo like ? or subtitulo like ?";
                    $consulta = $conexion->prepare($sentencia);
                    $consulta->bind_param("ss", $buscar, $buscar);
                    $consulta->bind_result($cod,$tit,$sub,$con,$fot,$fe);
                    $consulta->execute();
                    ...
                    if ($consulta->affected_rows == 0) {
                        ...
                        echo '<table class="table table-hover">
                            ...
                            echo "<tr>
                            <td>$cod</td><td><img style='width:70%' src='../img/noticias/$fot'></td>
                            <td>$tit</td><td>$sub</td><td>$fecha</td>
                            </tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
